...
public class RadialMenu : MonoBehaviour
{
    ...
    //Responsive menu game object
    public GameObject responsiveMenu;
    #endregion
    ...
    {
        //register finger on touchpadonly if responsive menu is not shown
