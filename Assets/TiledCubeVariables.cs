...
public class TiledCubeVariables : MonoBehaviour {
    ...
    public bool tiledCubeHasChanged = true;
    ...
    void Start () {
       ...
       // index = scatterplot.GetComponent<DataSpaceHandler>().ind;
        ...
        for(int i=0; i<vertices.Length; i+=24)
        {
            ...
            lr.material.color = scatterplot.GetComponent<DataSpaceHandler>().listOfColors[index];
            scatterplot.GetComponent<DataSpaceHandler>().ind++;
    ...
    void Update()
    {
        ...
        {
            tiledCubeHasChanged = true;
        }
        else
        {
            tiledCubeHasChanged = false;
        }

        if (tiledCubeHasChanged || planeHasChanged)
        {
